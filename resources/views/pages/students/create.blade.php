    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{__("university.add_student")}} </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">{{__("university.home")}}</a></li>
              <li class="breadcrumb-item active">{{__("university.add_student")}} </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                                        ...
                                        <label>{{ __("university.parents") }}</label>
                                            <select name="parent_id" class="form-control select2">
                                                ...
                                                @foreach ($parents as $parent)
                                                        <option value="{{ $parent->id }}">{{ $parent->first_name[LaravelLocalization::getCurrentLocale()] .' '.$parent->last_name[LaravelLocalization::getCurrentLocale()] }}</option>
                                                @endforeach
                                            </select>
                                        @error('parent_id')
                                            <div class="text-danger">{{ $message }}</div>
